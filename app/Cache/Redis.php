...
class Redis implements Cachelnterface
{
    public function __construct(private Client $client)
    {
    }

    public function get(string $key, mixed $default = nul ): mixed
    {
    ...
    {
        $this-»client-»del($key); return true;
    }
    
    public function clear(): bool
    {
        $this-»client-»flushall(); return true;
    }
    ...
    public function setMultiple(iterable $values, \DateInterval|int| null $ttl = null):bool
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($ttl !== null) {
            $ttlSeconds = $this-»convertTtlToSeconds($ttl); $this->client->expire($key, $ttlSeconds);
            }
        }
